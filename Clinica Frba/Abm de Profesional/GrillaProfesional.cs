    ...
    public partial class GrillaProfesional_Form : Form
    {
        ...
        public void actualizarListadoProfesionales()
        {
            ...
            foreach (ProfesionalDTO profesional in profesionalesAMostrar)
            {
                ...
                columnas[4] = profesional.TipoDni;
                columnas[5] = profesional.Dni;
                columnas[6] = profesional.NroMatricula;
                columnas[7] = profesional.Direccion;
                columnas[8] = profesional.Telefono;
                columnas[9] = profesional.Mail;
                columnas[10] = profesional.FechaNacimiento;
                columnas[11] = profesional.Sexo;
                columnas[12] = (profesional.Estado == "True") ? true : false;
