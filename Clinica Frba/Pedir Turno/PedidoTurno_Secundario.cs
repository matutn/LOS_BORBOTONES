...
namespace Clinica_Frba.Pedir_Turno
{
    public partial class PedidoTurno_Secundario : Form
    {
        ...
        private void button_Confirmar_Click(object sender, EventArgs e)
        {
            ...
            DataTable dt_turno = Clases.DB.ExecuteReader(@"select * from LOS_BORBOTONES.Turno where tur_IdAfi = " + idAfiliado + " AND tur_IdProf = " + dt_idProf.Rows[0]["prof_IdProfesional"] + " AND tur_Estado = " + 1 +
            ...
            {
                Clases.DB.ExecuteNonQuery("Insert into LOS_BORBOTONES.Turno (tur_IdProf,tur_IdAfi,tur_Especialidad,tur_Fecha,tur_Estado) values (" + dt_idProf.Rows[0]["prof_IdProfesional"] + "," + idAfiliado + "," + dt_especialidadProf.Rows[0]["espr_CodEspecialidad"] + ",'" + fechaConfirmacionTurno + "'," + 1 + ")");
